...
async function onDOMContentLoaded() {
    ...
    table = new Tabulator("#mainTable", {
        ...
        columns:[
            ...
            {title:"Boolean User Function (*)", field:"code" ,headerFilter:"input", headerFilterPlaceholder:"Text filter",editor:"textarea", editorParams: { verticalNavigation: "editor", } ,formatter: "plaintext" },
        ]
    });
