...
(function (global, factory) {
      ...
      },
      {
        ...
        value: function _buildColumnHeaderTitle() {
          ...
          if (def.editableTitle) {
            ...
            if (def.field) {
              this.langBind("columns|" + def.field, function (text) {
                _this7._formatColumnHeaderTitle(
                  titleHolderElement,
                  text || def.title || "&nbsp;",
                );
              });
    ...
    _createClass(VirtualDomHorizontal, [
      ...
      },
      {
        ...
        value: function rerenderColumns(update, blockRedraw) {
          ...
          this.vDomScrollPosRight =
            this.scrollLeft + this.elementVertical.clientWidth + this.window;
          var colPos = 0;
            ...
            if (change) {
              if (change && this.table.rowManager.getDisplayRows().length) {
                ...
                if (row) {
                  ...
                  for (
                    colEnd;
                    colEnd < this.table.columnManager.columnsByIndex.length;
                    colEnd++
                  ) {
                    this.table.columnManager.columnsByIndex[colEnd].setWidth(
                      this.fitDataColAvg,
                    );
                  }
      ...
      },
      {
        ...
        value: function addColRight() {
          ...
          if (
            column &&
            column.modules.vdomHoz.leftPos <= this.vDomScrollPosRight
          ) {
      ...
      },
      {
        ...
        value: function addColLeft() {
          ...
          if (
            column &&
            column.modules.vdomHoz.rightPos >= this.vDomScrollPosLeft
          ) {
            var rows = this.table.rowManager.getVisibleRows();
            rows.forEach(function (row) {
              if (row.type !== "group") {
              ...
              case "displayPipeline":
                for (var _i = index; _i < this.displayPipeline.length; _i++) {
                  var _result = this.displayPipeline[_i].handler(
                    (_i ? this.getDisplayRows(_i - 1) : this.activeRows).slice(
                      0,
                    ),
                    renderInPosition,
                  );
      ...
      },
      {
        ...
        value: function setData(data, params, config) {
          if (this.initialized) {
            ...
            console.warn(
              "setData failed - table not yet initialized. To set initial data please use the 'data' property in the table constructor.",
            );
          }
        }, //clear data
      },
      ...
      },
      {
        ...
        value: function replaceData(data, params, config) {
          if (this.initialized) {
            ...
            console.warn(
              "replaceData failed - table not yet initialized. Please wait for the `tableBuilt` event before calling this function.",
            );
          }
        }, //update table data
      },
      {
        ...
        value: function updateData(data) {
          ...
          if (this.initialized) {
            return new Promise(function (resolve, reject) {
              ...
              if (data) {
                data.forEach(function (item) {
                  var row = _this2.rowManager.findRow(
                    item[_this2.options.index],
                  );
            ...
            console.warn(
              "updateData failed - table not yet initialized. Please wait for the `tableBuilt` event before calling this function.",
            );
          }
        },
      },
      {
        ...
        value: function addData(data, pos, index) {
          ...
          if (this.initialized) {
            ...
            console.warn(
              "addData failed - table not yet initialized. Please wait for the `tableBuilt` event before calling this function.",
            );
          }
        }, //update table data
      },
        ...
        value: function updateOrAddData(data) {
          ...
          if (this.initialized) {
            return new Promise(function (resolve, reject) {
              ...
              if (data) {
                data.forEach(function (item) {
                  var row = _this4.rowManager.findRow(
                    item[_this4.options.index],
                  );
            ...
            console.warn(
              "updateOrAddData failed - table not yet initialized. Please wait for the `tableBuilt` event before calling this function.",
            );
          }
        }, //get row object
      },
      ...
      },
      {
        ...
        value: function addRow(data, pos, index) {
          if (this.initialized) {
            ...
            console.warn(
              "addRow failed - table not yet initialized. Please wait for the `tableBuilt` event before calling this function.",
            );
          }
      ...
      },
      {
        ...
        value: function setColumns(definition) {
          if (this.initialized) {
            ...
            console.warn(
              "setColumns failed - table not yet initialized. To set initial data please use the 'columns' property in the table constructor.",
            );
          }
        },
      },
      ...
      },
      {
        ...
        value: function sendRequest(url, params, config) {
          ...
          if (
            ...
            return this.loaderPromise(url, config, params).then(
              function (data) {
      ...
      },
      {
        ...
        value: function generateRow(pos, data) {
          ...
          row.generateCells = function () {
            ...
            _this4.table.columnManager.columnsByIndex.forEach(
              function (column) {
                ...
                if (
                  ...
                  _this4.genColumn.modules.format = {
                    ...
                    params:
                      column.definition[pos + "CalcFormatterParams"] || {},
                  };
                } else {
                  _this4.genColumn.modules.format = {
                    formatter:
                ...
                _this4.genColumn.definition.cssClass =
                  column.definition.cssClass; //generate cell and assign to correct column
        ...
        value: function generateChildren(row) {
          ...
          childArray.forEach(function (childData) {
            ...
            if (childRow.modules.dataTree.children) {
              childRow.modules.dataTree.open = _this6.startOpen(
          ...
          if (_typeof(subject) == "object") {
            if (subject instanceof Row) {
              ...
              if (parent.modules.dataTree) {
                match = parent.modules.dataTree.children.find(
                  function (childRow) {
          ...
          if (config.children) {
            ...
            config.children.forEach(function (childRow) {
              if (childRow instanceof Row) {
                ...
                if (recurse) {
                  output = output.concat(
                    _this8.getTreeChildren(childRow, component, recurse),
                  );
                }
              }
            });
    ...
    function fillList() {
      ...
      displayItems.forEach(function (item) {
        ...
        if (!el) {
          ...
          item.label = editorParams.listItemFormatter
            ? editorParams.listItemFormatter(
                item.value,
                item.label,
                cell,
                el,
          ...
          if (
            ...
            for (var key in item.elementAttributes) {
              if (key.charAt(0) == "+") {
                ...
                el.setAttribute(
                  key,
                  input.getAttribute(key) + item.elementAttributes["+" + key],
                );
              } else {
    ...
    function scrollTovalue(_char) {
      ...
      var match = dataItems.find(function (item) {
        return (
          ...
          item.label.toLowerCase().startsWith(searchWord)
        );
      });
    ...
    function parseItems(inputValues) {
      ...
      if (Array.isArray(inputValues)) {
        inputValues.forEach(function (value) {
          ...
          if (_typeof(value) === "object") {
            item.title = editorParams.listItemFormatter
              ? editorParams.listItemFormatter(value.value, value.label)
              : value.label;
        ...
        value: function edit(cell, e, forceEdit) {
          ...
          function success(value) {
            if (self.currentCell === cell) {
              ...
              if (
                cell.column.modules.validate &&
                self.table.modExists("validate") &&
                self.table.options.validationMode != "manual"
              ) {
        ...
        value: function genereateRowElement(row, setup, styles) {
          ...
          row.columns.forEach(function (col) {
            if (col) {
              ...
              if (styles.firstCell) {
                _this8.mapElementStyles(styles.firstCell, cellEl, [
                  "padding-top",
                  "padding-left",
                  "padding-right",
                  "padding-bottom",
  ...
  function datetime(cell, formatterParams, onRendered) {
    ...
    if (typeof DT != "undefined") {
      var newDatetime =
        inputFormat === "iso"
          ? DT.fromISO(String(value))
          : DT.fromFormat(String(value), inputFormat);
        ...
        value: function layoutColumnPosition(allCells) {
          ...
          this.leftColumns.forEach(function (column, i) {
            column.modules.frozen.margin =
              _this4._calcSpace(_this4.leftColumns, i) +
              _this4.table.columnManager.scrollLeft +
              "px";
          ...
          this.rightColumns.forEach(function (column, i) {
            column.modules.frozen.margin =
              _this4.rightPadding -
              _this4._calcSpace(_this4.rightColumns, i + 1) +
              "px";
      ...
      return new Proxy(this, {
        get: function get(target, name, receiver) {
          if (typeof target[name] !== "undefined") {
            ...
            return target._group.table.componentFunctionBinder.handle(
              "row",
              target._group,
              name,
            );
    ...
    _createClass(Menu, [
      ...
      },
      {
        ...
        value: function lookupMenuContainer() {
          ...
          if (
            this.menuContainer &&
            !this.checkMenuContainerIsParent(this.menuContainer)
          ) {
        ...
        value: function checkMenuContainerIsParent(container) {
          ...
          if (container === element) {
            ...
            return element.parentNode
              ? this.checkMenuContainerIsParent(container, element.parentNode)
              : false;
          }
        },
      },
        ...
        value: function loadMenuEvent(menu, e, component) {
          ...
          menu =
            typeof menu == "function"
              ? menu.call(this.table, component.getComponent(), e)
              : menu;
      ...
      },
      {
        ...
        value: function positionMenu(element, parentEl, touch, e) {
          ...
          setTimeout(function () {
            _this4.table.rowManager.element.addEventListener(
              "scroll",
              _this4.blurEvent,
            );
          ...
          if (
            x + element.offsetWidth >= this.menuContainer.offsetWidth ||
            ...
            if (parentEl) {
              element.style.right =
                this.menuContainer.offsetWidth - parentOffset.left + "px";
            } else {
  ...
  function datetime$1(a, b, aRow, bRow, column, dir, params) {
    ...
    if (typeof DT != "undefined") {
      a =
        format === "iso"
          ? DT.fromISO(String(a))
          : DT.fromFormat(String(a), format);
      b =
        format === "iso"
          ? DT.fromISO(String(b))
          : DT.fromFormat(String(b), format);
